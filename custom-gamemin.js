(function (qc) {
  ...
  Ba.b = !0;
  Ba.cg = function (a) {
    return new PerfectScrollbar(a, { handlers: Ba.Uo });
  };
  mc.b = !0;
  mc.ts = function () {
    var a = window;
          ...
          2 == a.length
            ? ((a = K.parseInt(a[1])),
              null != a && -999 <= a && 999 >= a
                ...
                : this.ba(
                    "Extrapolation must be a value between -999 and 999 milliseconds"
                  ))
  ...
  x.fj = function (a) {
    x.ks() &&
      x.es(function () {
        ...
        return Promise.all([
          M.L("res.dat", "arraybuffer").then(function (a) {
            a = new JSZip(a);
            n.Na = new Ub(a);
            return Promise.all([
              n.Na.ro,
  ...
  Qa.prototype = C(m.prototype, {
    apply: function (a) {
      if (a.Lb(this.P, 1)) {
        ...
        0 != c &&
          (f == e
            ? 2 > c || (a.Mf(b, d[0], p.fa), a.Mf(b, d[1], p.xa))
            : a.Mf(b, d[0], f > e ? p.fa : p.xa));
      }
    },
    ua: function () {},
    va: function () {},
      ...
      for (b = this.F.length; a < b; ) {
        ...
        if (0 != c.aa) {
          ...
          for (e = this.U; d < e.length; )
            (f = e[d]), ++d, 0 != (f.h & c.v) && 0 != (f.v & c.h) && c.Qn(f);
          d = 0;
